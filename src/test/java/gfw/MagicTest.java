...
public class MagicTest extends TestCase {
    private static final String gifFile = "test_docs/test.gif";
    private static final String pngFile = "test_docs/test.png";
    private static final String tifFile = "test_docs/test_nocompress.tif";
    private static final String jpgFile = "test_docs/test.jpg";
    private static final String textFile = "test_docs/test.txt";
    private static final String officeOpenXmlDocumentFile = "test_docs/test_word.docx";
    private static final String officeOpenXmlDocumentFile2 = "test_docs/test_word.docm";
    private static final String word2KFile = "test_docs/test_word_2000.doc";
    private static final String word95File = "test_docs/test_word_6.0_95.doc";
    private static final String rtfFile = "test_docs/test.rtf";
    private static final String officeOpenXmlWorkbookFile = "test_docs/test_excel.xlsx";
    private static final String officeOpenXmlWorkbookFile2 = "test_docs/test_excel.xlsm";
    private static final String officeOpenXmlPresentationFile = "test_docs/test_powerpoint.pptx";
    private static final String officeOpenXmlPresentationFile2 = "test_docs/test_powerpoint.pptm";
    private static final String excel2KFile = "test_docs/test_excel_2000.xls";
    private static final String pdfFile = "test_docs/test.pdf";
    private static final String psFile = "test_docs/test.ps";
    private static final String javaClass12File = "test_docs/test_1.2.class";
    private static final String javaClass13File = "test_docs/test_1.3.class";
    private static final String javaClass14File = "test_docs/test_1.4.class";
    private static final String mp3_128_44_jstereoFile = "test_docs/test_128_44_jstereo.mp3";
    private static final String wavFile = "test_docs/test.wav";
    private static final String odtFile = "test_docs/test.odt";
    private static final String zipFile = "test_docs/test.zip";
    ...
    public void testSubMatches() {
        ...
        try {
            MagicMatch match = Magic.getMagicMatch(new File(gifFile), true, false);
            assertEquals(3, match.getSubMatches().size());
